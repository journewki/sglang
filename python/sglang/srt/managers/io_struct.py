...
ImageDataInputItem = Union[str, Dict[str, Any], ImageData, Image]
AudioDataInputItem = Union[str, Dict[str, Any]]
VideoDataInputItem = Union[str, Dict[str, Any], VideoData]
...
ModalityHint = Literal["image", "multi-images", "video", "audio"]
...
class GenerateReqInput:
    ...
    modalities: Optional[List[Optional[ModalityHint]]] = None
    ...
    def __getitem__(self, i):
        ...
        sub = GenerateReqInput(
            ...
            modalities=(
                [self.modalities[i]]
                if self.modalities and self.modalities[i] is not None
                else None
            ),
...
class TokenizedEmbeddingReqInput(BaseReq):
    input_text: Optional[Union[str, List[str], List[List[str]]]]
    # The input token ids
...
HiddenStateVector = List[float]
HiddenStateChunk = Union[HiddenStateVector, List[HiddenStateVector]]
